...
const botonInicioPausa = document.querySelector('#boton-iniciar');
...
botonInicioPausa.addEventListener('click', function() {
  if (estadoCronometro === 'pausado') {
    ...
    document.getElementById('boton-iniciar').innerHTML = `<i class="bi bi-pause" id="boton-inicio-pausa"></i>`;
    ...
    document.getElementById('boton-iniciar').innerHTML = `<i class="bi bi-play-fill" id="boton-inicio-pausa"></i>`;
...
botonReiniciar.addEventListener('click', function() {
  ...
  // Botones.
  document.getElementById('boton-iniciar').innerHTML = `<i class="bi bi-play-fill" id="inicio"></i>`;
  botonInicioPausa.classList.remove('pausar');
  botonInicioPausa.classList.add('iniciar');
